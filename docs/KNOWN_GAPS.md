...
| Mint experience | Card backs | Partial | A card back is now selectable from the app library **by id** (`backId`, Mint FX ▸ Pack & card art). Per-rarity / rules-driven flip sides still pending. |
