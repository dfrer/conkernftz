...
| Site builder | Canvas ergonomics | Partial | Drag-move + corner-resize, **undo/redo** (Ctrl/Cmd+Z · +Shift/Ctrl+Y · buttons), **snap-to-grid** (20px toggle), and **arrow-key nudge** (Shift = 10px) all shipped. Still pending: multi-select, group, and rotation. |
