...
| **Build** | ✅ build (output count asserted); **Audit assets + outputs (output renders); rarity-report Reload** | ☐ pause/resume/stop + progress events (trivial direct-IPC wiring; only appear mid-build — the instant mock can't simulate progress); open-folder (native) |
